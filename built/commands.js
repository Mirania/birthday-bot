...
exports.invite = exports.setup = exports.birthday = void 0;
...
function setup(message) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const data = data_1.getData();
        if (((_b = (_a = data[message.author.id]) === null || _a === void 0 ? void 0 : _a.adminConfigState) !== null && _b !== void 0 ? _b : 0) !== data_1.State.None) {
            utils.send(message, "Please finish the ongoing setup process first!");
            return;
        }
        const dm = yield message.author.createDM();
        utils.send(dm, "Alright, let's configure your birthday notification!\n" +
