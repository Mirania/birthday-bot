...
exports.numberToMonth = exports.genderConfirmer = exports.genderParser = exports.timeConfirmer = exports.bdayUtc = exports.timeParser = exports.dateConfirmer = exports.dateParser = void 0;
...
function genderConfirmer(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (parsed.answer) {
            ...
            user.state = data_1.State.Done;
            data_1.saveUser(message.author.id);
        }
        else {
...
function getClosestTimezone(hour, minute) {
    ...
    for (const tz in data_1.getTimezoneOffsets()) {
        ...
        if (!isSameDay(now, hour, minute)) { // cannot compare the same day
            if (hour > now.hour())
                date.subtract(1, "day"); // they are in the previous day
            else
                date.add(1, "day"); // they are in the next day
        }
